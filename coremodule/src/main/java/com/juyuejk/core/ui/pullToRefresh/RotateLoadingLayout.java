...
//    	11-18 14:44:45.805: I/System.out(16103): R.id.pull_to_refresh_header_content2 = 2131361806
//    	System.out.println("R.id.pull_to_refresh_header_content2 = " + R.id.pull_to_refresh_header_content);
//        mHeaderContainer = (RelativeLayout) container.findViewById(R.id.pull_to_refresh_header_content);
//        mArrowImageView = (ImageView) container.findViewById(R.id.pull_to_refresh_header_arrow);
//        mHintTextView = (TextView) container.findViewById(R.id.pull_to_refresh_header_hint_textview);
//        mHeaderTimeView = (TextView) container.findViewById(R.id.pull_to_refresh_header_time);
//        mHeaderTimeViewTitle = (TextView) container.findViewById(R.id.pull_to_refresh_last_update_time_text);
    ...
    protected View createLoadingView(Context context, AttributeSet attrs) {
        container = LayoutInflater.from(context).inflate(R.layout.pull_to_refresh_header2, null);
