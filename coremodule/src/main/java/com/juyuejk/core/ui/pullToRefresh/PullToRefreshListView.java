...
import com.juyuejk.core.ui.pullToRefresh.ILoadingLayout.State;
...
public class PullToRefreshListView extends PullToRefreshBase<ListView> implements OnScrollListener {
    ...
    protected ListView createRefreshableView(Context context, AttributeSet attrs) {
        ...
        try {
            dividerColor = attrs.getAttributeResourceValue(namespace, "divider", -1);//获取到的是一个资源指向的内存地址like：@2131427430
            LogPrinter.e(TAG, "attrs name=divider attrs value=" + dividerColor);
        } catch (Exception e) {
            e.printStackTrace();
        }
        ...
        //取出来实际的像素的值
        try {
            String temp = attrs.getAttributeValue(namespace, "dividerHeight");
        ...
        LogPrinter.e(TAG, "attrs name=dividerHeight attrs value=" + height);

        if (dividerColor != -1){
            listView.setDivider(getResources().getDrawable(dividerColor));
//            int color = R.color.main_color; @2131427430
