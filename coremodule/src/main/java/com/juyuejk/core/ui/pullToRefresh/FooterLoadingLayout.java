...
public class FooterLoadingLayout extends LoadingLayout {
    ...
    private void init(Context context) {
        ...
        mFootContent = (LinearLayout) container.findViewById(R.id.pull_to_load_footer_content);
    ...
    public int getContentSize() {
        View view = container.findViewById(R.id.pull_to_load_footer_content);
        if (null != view) {
    ...
    protected void onNoMoreData() {
    	mFootContent.setVisibility(View.GONE);
