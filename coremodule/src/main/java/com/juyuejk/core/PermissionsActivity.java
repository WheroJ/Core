 ...
 */
public class PermissionsActivity extends BFActivity {
    ...
    private static final String EXTRA_PERMISSIONS =
            CoreInit.getInstance().mContext.getPackageName() + ".extra_permission"; // 权限参数
    ...
    @Override protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        RelativeLayout relativeLayout = new RelativeLayout(thisContext);
